...
pdf(file = "BP/dotplots_E_BP_sig.pdf")
## E_down
res_cd <- ora_results_BP[["E_down"]]
...
pdf(file = "MF/dotplots_E_MF_sig.pdf")
## E_down
...
pdf(file = "CC/dotplots_E_CC_sig.pdf")
## E_down
